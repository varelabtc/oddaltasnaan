...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        "Vi que você tem interesse em entrar no *Grupo de Alavancagem NAAN Tips* 📈, certo?\n\n"
        "Me responde aqui: *Você já possui conta na SportingBet?*\n\n"
        "_É uma das maiores casas do mercado, regulamentada e patrocinadora "
        "do Palmeiras e da Conmebol Libertadores_ 🏆",
...
async def resposta_tem_conta(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await query.edit_message_text(
        ...
        "Me manda um print da *tela inicial da sua conta* na SportingBet "
...
async def callback_admin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if acao == "aprovar":
            ...
            try:
                await context.bot.send_message(
                    ...
                    text=(
                        ...
                        f"Agora deposita *R$ {VALOR_MINIMO},00* na SportingBet "
            ...
            try:
                await context.bot.send_message(
                    ...
                    text=(
                        ...
                        "Seja bem-vindo ao *Grupo de Alavancagem NAAN Tips* 📈\n\n"
        ...
        if tipo == "boasvindas":
            instrucao = "a tela inicial da SportingBet esteja visível e legível"
